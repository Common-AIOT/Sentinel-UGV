...
| CTRL-18 | 초음파 임계거리 진입 | 센서 ESP32가 즉시 `protective_stop` 보고, Jetson 중계로 모터 ESP32가 정지, 왕복 지연 실측·기록(TBD-HW-011). **중계는 구현됐고(S15P11A301-237) 판정 로직만 단위 시험으로 고정된 상태다 — 왕복 지연은 미실측** |
