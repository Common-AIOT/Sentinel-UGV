...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Nav2 는 기본 꺼짐 (S15P11A301-235). 통합 자원 계측은 끝났지만
        # 탐지 성능과 전륜 조향 실차 경로 추종이 데모 기준을 아직 통과하지 못했다.
        # 따라서 자율주행 시험에서만 명시적으로 켠다.
        ...
        # 만든다. 트랙폭·바퀴 지름의 1차 실측은 반영됐지만 센서 펌웨어의 주기 계산
        # 수정 뒤 엔코더·IMU 재계측과 조향 링키지 보정 확인이 남았다. 그래서 실차
        # 주행 전 점검을 수행한 뒤 사람이 명시적으로 켜야 한다.
        #
