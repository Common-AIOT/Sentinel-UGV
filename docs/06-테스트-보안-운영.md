...
> | ID | 막고 있는 것 |
> |---|---|
> | FR-003 (frontier 3개 순차 선택) | `sentinel_exploration` 소스 0개. `/cmd_vel` 소비자도 없다 (04장 8.2, S15P11A301-172·234) |
> | FR-004 (충돌 0회, 우회 또는 안전 정지) | Nav2·`collision_monitor`·안전 체인 미구현 (S15P11A301-235·237) |
> | FR-011 (입력 단절 후 300ms 이내 PWM 0) | ESP32 watchdog 은 있으나 ROS 측 `safety_gate` 가 없다. 실차 계측도 미실시 (TBD-HW-011) |
