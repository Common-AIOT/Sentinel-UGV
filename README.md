...
전체 개발 기준은 [최종 통합 명세서 v1.0-rc3](docs/Sentinel_UGV_최종_통합_명세서_v1.0-rc3.md)와 [Git 컨벤션](docs/git_convention.md)을 참고하세요.
...
현재 저장소는 최종 통합 명세서 v1.0-rc3에 맞춘 초기 모노레포 골격입니다. 구현 기준은 통합 명세서, 협업 기준은 Git 컨벤션을 따릅니다.
