...
프레임 크기 31KB는 정적 실내 장면 값이고, S15P11A301-66 당시에는 약 105KB였다. 장면 복잡도에 따라 Fast DDS 단편화 임계(약 64KB) 양쪽을 오가므로 PoC-B에서 최대값을 별도로 측정한다([`jetson/streaming_poc/poc/README.md`](../streaming_poc/poc/README.md)).
