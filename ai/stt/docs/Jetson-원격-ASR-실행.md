...
- Jetson 음성 코드: `~/projects/S15P11A301/ai/stt`
- Jetson Python: `~/projects/S15P11A301/.venv/bin/python`
- GPU 서버 코드: `/home/j-i15a301/a301-gpu-asr/ai/stt/gpu_server`
...
파일은 정확히 `~/projects/S15P11A301/ai/stt/.env`다. 저장소에 커밋하지 않는다.
...
녹음 증적은
`~/projects/S15P11A301/ai/stt/results/jetson-preflight/<UTC시각>/`에 저장된다.
...
`ai/stt/sessions/<세션시각>/session.jsonl`에 남는다. 이 정상 동작을 확인한 뒤 같은
